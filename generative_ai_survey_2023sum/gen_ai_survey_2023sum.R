...
server<-function(input, output) {
  ...
  output$attitudepie_all<-renderPlot(attitude_pie)
  output$attitudeplot_all<-renderPlot(attitude_plot)
  output$familiarpie_all<-renderPlot(familiar_pie)
  output$familiarplot_all<-renderPlot(familiar_plot)
  output$everpie_all<-renderPlot(ever_pie)
  output$everplot_all<-renderPlot(ever_plot)
  
  output$learningplot_all<-renderPlot(learning_plot)
  output$pedagogyplot_all<-renderPlot(pedagogy_plot)
  output$workloadplot_all<-renderPlot(workload_plot)
  output$engagementplot_all<-renderPlot(engagement_plot)
  output$equityplot_all<-renderPlot(equity_plot)
